...
But where does this result *come from*? As I was working my way through 
...
additional commentary and code I wrote to actually implement the algorithms
described herein. 
<!-- 
I hadn't much experience in the way of technical mathematical writing prior to
this course, so I've written it in the "proposition, then proof" style, where
I state a result... and then prove it.
-->
...
$T_{n,m}$ is the maximum of these values. The entire
source for this post is available [here][hw7_kstest.py]. 
...
<figure>
<img src="/assets/images/ks2samp/ks_test.pdf" id="fig:ks_test"  /><figcaption><span class="fig_number">Figure 1</span>. The empirical cdfs of two independent random samples from <span class="math inline">\(\mathcal{N}\left( 0, 1 \right)\)</span> and <span class="math inline">\(\mathcal{N}\left( 0, 2 \right)\)</span>. The test statistic <span class="math inline">\(T_{n,m}\)</span> is shown by the double arrow.</figcaption>
</figure>
...
<figure>
<img src="/assets/images/ks2samp/ks_dist.pdf" id="fig:Tnm"  />
...
[^2]: The *indicator function* is defined as
