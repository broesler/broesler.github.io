...
class="sidenote-wrapper"><label for="sn-0" class="margin-toggle sidenote-number"></label>
...
[practical limitations][gordon2010] to [using][wilcox1997] K-S tests, but
overall it has become a [practical][medium] tool to hang on your belt.

<p class="message" markdown=1>The entire source for this post is available [here][hw7_kstest.py].</p>
